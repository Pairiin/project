              ...
              <div class="row">
                <div class="col-lg-6">
                  ...
                  <div class="well bs-component">
                    ...
                    <form action="a_setting_email_edit_process.php"  id="form"  class="form-horizontal" method="post">
                      <fieldset>
                        ...
                        <div class="form-group">
                          ...
                          <div class="col-lg-8">
                            <input class="form-control" name="email_name" id="email_name" type="text" value="<?=$objResult['email_name']?>" >
                          </div>
                        </div>
                          ...
                          <div class="col-lg-8">
                            <input class="form-control" name="email" id="email" type="text" value="<?=$objResult['email']?>"  >
                          </div>
                        </div>
												...
												<div class="form-group">
													...
													<div class="col-lg-8 	">
														<input class="form-control" name="password" id="password" type="password" value="<?=$objResult['email_password']?>" >
													</div>
												</div>
                        ...
                        <div class="form-group">
                          <div class="col-lg-10 col-lg-offset-4">
														<input type="hidden" name="id_email" value="<?=$objResult['id_email']?>">
